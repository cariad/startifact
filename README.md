...
- [Deploying an S3 bucket](#deploying-an-s3-bucket)
- [Organisation setup](#organisation-setup)
  - [Introduction](#introduction)
  - [Choosing where to host the configuration](#choosing-where-to-host-the-configuration)
  - [Performing or updating the organisation setup](#performing-or-updating-the-organisation-setup)
  - [Questions](#questions)
    - [Q1: Confirm the configuration parameter location](#q1-confirm-the-configuration-parameter-location)
    - [Q2: Bucket name parameter](#q2-bucket-name-parameter)
    - [Q3: Bucket name parameter region](#q3-bucket-name-parameter-region)
    - [Q4: Bucket region](#q4-bucket-region)
    - [Q5: Bucket key prefix](#q5-bucket-key-prefix)
    - [Q6: Artifact parameter region](#q6-artifact-parameter-region)
    - [Q7: Artifact parameter name prefix](#q7-artifact-parameter-name-prefix)
    - [Q8: Confirmation](#q8-confirmation)
- [IAM policies](#iam-policies)
- [Usage](#usage)
  - [CLI usage](#cli-usage)
    - [Staging an artifact via the CLI](#staging-an-artifact-via-the-cli)
    - [Getting the latest version number of a project via the CLI](#getting-the-latest-version-number-of-a-project-via-the-cli)
    - [Downloading the latest version of an artifact via the CLI](#downloading-the-latest-version-of-an-artifact-via-the-cli)
    - [Downloading a specific version of an artifact via the CLI](#downloading-a-specific-version-of-an-artifact-via-the-cli)
  - [Python usage](#python-usage)
    - [Staging an artifact via Python](#staging-an-artifact-via-python)
    - [Getting the latest version number of a project via Python](#getting-the-latest-version-number-of-a-project-via-python)
    - [Downloading the latest version of an artifact via Python](#downloading-the-latest-version-of-an-artifact-via-python)
    - [Downloading a specific version of an artifact via Python](#downloading-a-specific-version-of-an-artifact-via-python)
- [Project](#project)
